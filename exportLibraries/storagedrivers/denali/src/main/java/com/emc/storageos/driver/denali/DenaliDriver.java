...
public class DenaliDriver extends DefaultStorageDriver implements BlockStorageDriver {
    ...
    public static final String DRIVER_NAME = "DenaliDriver";
    ...
    private static final String DENALI_CONF_FILE = "denali-conf.xml";
    private static final String CONFIG_BEAN_NAME = "denaliConfig";

    private ApplicationContext parentApplicationContext;
    private DenaliConfiguration denaliConfig;
    ...
    public DenaliDriver() {
        ApplicationContext context = new ClassPathXmlApplicationContext(new String[] {DENALI_CONF_FILE}, parentApplicationContext);
        denaliConfig = (DenaliConfiguration) context.getBean(CONFIG_BEAN_NAME);
    }
    ...
    public RegistrationData getRegistrationData() {
        RegistrationData registrationData = new RegistrationData("denaliDriver", "denalisystem", null);
    ...
    public DriverTask getTask(String taskId) {
        ...
        if (taskOperation.getLookupCount() < denaliConfig.getMaxAsynchronousLookups()) {            
            ...
            if (denaliConfig.getSimulateFailures()) {
...
//        }
    ...
    public DriverTask createVolumes(List<StorageVolume> volumes, StorageCapabilities capabilities) {
        ...
        for (StorageVolume volume : volumes) {
            volume.setNativeId("denaliDriverVolume" + UUID.randomUUID().toString());
    ...
    public DriverTask expandVolume(StorageVolume volume, long newCapacity) {
        ...
        if (denaliConfig.getSimulateAsynchronousResponses()) {
            ...
            return driverTask;
        } else if (denaliConfig.getSimulateFailures()) {
    ...
    public boolean validateStorageProviderConnection(StorageProvider storageProvider) {
        String msg = String.format("Request to validate connection to storage provider with type: %s, host: %s, port: %s ", storageProvider.getProviderType(), storageProvider.getProviderHost(), storageProvider.getPortNumber());
        _log.info(msg);
        return true;
}
